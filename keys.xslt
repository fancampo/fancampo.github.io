<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/1999/xhtml" xmlns:html="http://www.w3.org/1999/xhtml" xmlns:env="http://panax.io/state/environment" xmlns:xo="http://panax.io/xover">
	...
	<xsl:key name="image" match="data[contains(@type,'System.Resources.ResXFileRef')]/value" use="'*'"/>
	<xsl:key name="image" match="data[contains(@type,'System.Resources.ResXFileRef')]/value" use="concat('#',../@name)"/>
	...
	<xsl:key name="image" match="data[contains(@type,'System.Resources.ResXFileRef')]/value" use="concat('#',substring-before(../@name,' ('))"/>
